...
export default function Zaehlersteckklemmen() {
  ...
  const page = (productDetailContent[lang] || productDetailContent.de).zaehlersteckklemmen
        ...
        <div className="container zt-hero-inner">
          ...
          <div className="zt-hero-text">
            <nav className="zt-breadcrumb reveal" style={{'--sr-delay':'0s'}}>
              ...
              <span>/</span>
              <button className="zt-bc-btn" onClick={() => { window.location.href = '/'; setTimeout(() => document.getElementById('products')?.scrollIntoView({ behavior: 'smooth' }), 150) }}>{t('productPage.breadcrumb_products')}</button>
              <span>/</span>
            ...
            <h1 className="zt-hero-h1 reveal-blur" style={{'--sr-delay':'0.18s'}}>
              {page.heroTitle1}<br />
              <span className="zt-green">{page.heroTitle2}</span>
            </h1>
            <p className="zt-hero-desc reveal" style={{'--sr-delay':'0.28s'}}>{page.heroDesc}</p>
      ...
      <section id="zt-explorer" className="zt-3d-section">
        ...
        <div className="container zt-3d-layout">
          <div className="zt-3d-text reveal">
            ...
            <h2 className="zt-3d-heading">{t('productPage.explore_heading')}</h2>
            <p className="zt-3d-body">{page.explorerBody}</p>
        ...
        <div className="container">
          ...
          <div className="zt-specs-layout reveal">
            <div className="zt-specs-image-wrap">
              <img src="/images/products/plug_in_meter_connection_terminals.png" alt={page.imageAlt} className="zt-specs-img" />
